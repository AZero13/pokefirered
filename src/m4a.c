...
#define COMMON_DATA_M4A(n) __attribute__((section("common_data." #n)))

BSS_CODE ALIGNED(4) char SoundMainRAM_Buffer[0x800] = {0};

COMMON_DATA_M4A(001) struct SoundInfo gSoundInfo = {0};
COMMON_DATA_M4A(002) struct PokemonCrySong gPokemonCrySongs[MAX_POKEMON_CRIES] = {0};
COMMON_DATA_M4A(003) struct MusicPlayerInfo gPokemonCryMusicPlayers[MAX_POKEMON_CRIES] = {0};
COMMON_DATA_M4A(004) struct MusicPlayerInfo gMPlayInfo_BGM = {0};
COMMON_DATA_M4A(005) MPlayFunc gMPlayJumpTable[36] = {0};
COMMON_DATA_M4A(006) struct CgbChannel gCgbChans[4] = {0};
COMMON_DATA_M4A(007) struct MusicPlayerInfo gMPlayInfo_SE1 = {0};
COMMON_DATA_M4A(008) struct MusicPlayerInfo gMPlayInfo_SE2 = {0};
COMMON_DATA_M4A(009) struct MusicPlayerTrack gPokemonCryTracks[MAX_POKEMON_CRIES * 2] = {0};
COMMON_DATA_M4A(010) struct PokemonCrySong gPokemonCrySong = {0};
COMMON_DATA_M4A(011) u8 gMPlayMemAccArea[0x10] = {0};
COMMON_DATA_M4A(012) struct MusicPlayerInfo gMPlayInfo_SE3 = {0};
