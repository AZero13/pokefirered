...
COMMON_DATA_M4A(004) MPlayFunc gMPlayJumpTable[36] = {0};
COMMON_DATA_M4A(005) struct CgbChannel gCgbChans[4] = {0};
COMMON_DATA_M4A(006) struct MusicPlayerTrack gPokemonCryTracks[MAX_POKEMON_CRIES * 2] = {0};
COMMON_DATA_M4A(007) struct PokemonCrySong gPokemonCrySong = {0};
COMMON_DATA_M4A(008) struct MusicPlayerInfo gMPlayInfo_BGM = {0};
COMMON_DATA_M4A(009) struct MusicPlayerInfo gMPlayInfo_SE1 = {0};
COMMON_DATA_M4A(010) struct MusicPlayerInfo gMPlayInfo_SE2 = {0};
